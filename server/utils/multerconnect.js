...
const fileStorage = multer.diskStorage({
	...
	filename: (req, file, cb) => {
		let filename = `${file.fieldname}_${uuid.v4()}${path.extname(file.originalname)}`
		cb(null, filename);
	},
})
